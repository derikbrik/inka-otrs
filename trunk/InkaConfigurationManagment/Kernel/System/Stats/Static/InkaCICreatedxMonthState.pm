# --
# Kernel/System/Stats/Static/InkaCICreatedxMonthState.pm - stats module
# Copyright (C) 2011 Juan Manuel Rodriguez
# --
# $Id: InkaCICreatedxMonthState.pm $
# --
...
package Kernel::System::Stats::Static::InkaCICreatedxMonthState;
...
sub Run {
	...
	my ( $Self, %Param ) = @_;	
	return  $Self->{StatsObject}->CICreatedxMonthAndState( year => $Param{Year}, month => $Param{Month}, dateType => $Param{DatetoUse});
}
